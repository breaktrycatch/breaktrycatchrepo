package com.fuelindustries.util 
{
	...
	public class DictionaryExtensions 
	{
		...
		/**
		 * Executes functions on both the keys and the values in the Dictionary and constructs a new Dictionary
		 * of keys and values corresponding to the results of the functions.
		 * @param dict A source Dictionarty to map values from.
		 * @param valueFn A function to generate values. 
		 * @param keyFn An optional function to generate keys. If no function is given, the key of the original Dictionary is used.
		 * @return A Dictionary containing the mapped keys and values.
		 */
		public static function map(dict : Dictionary, valueFn : Function, keyFn : Function = null) : Dictionary
		{
			var newDict : Dictionary = new Dictionary(true);
			forEach(dict, function(value : *, key : *, dict : Dictionary):void
			{
				newDict[(keyFn == null) ? (key) : (keyFn(value, key, dict))] = valueFn(value, key, dict); 
			});
			return newDict;
		}
