package com.fuelindustries.events
{
	...
	public class ListEvent extends Event
	{
		...
		private var __item:ICellRendererData;
		 ...
		 */
		public function get item():ICellRendererData
		{
			return( __item );	
		}
		 ...
		 */
		public function ListEvent( eventType:String, item:ICellRendererData, index:int, rowIndex:int )
		{
			__item = item;
			__index = index;
			__rowIndex = rowIndex;
