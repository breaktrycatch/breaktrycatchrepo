...
public class ProcessorPipeline
{
	...
	private TileImageDrawer _drawer;
	...
	public void setDebugDrawer(TileImageDrawer drawer)
	{
		_drawer = drawer;
	}

	public ProcessorPlugin addPlugin(Class<?> c, String id) throws InvocationTargetException
	{
	...
	public ProcessorPlugin insertPlugin(Class<?> c, String id, String oldID) throws InvocationTargetException
	{
	...
	private ProcessorPlugin getPluginInstance(Class c, String id) throws InvocationTargetException
	{
		try
		{
			...
			constructorParams = new Class[] { ProcessorPipeline.class, String.class };
		...
		{
			throw new InvocationTargetException(e, "can't instantiate plugin: " + c.getName());
		}
	}
	...
	{
		for (Iterator<ProcessorPlugin> i = pipeline.iterator(); i.hasNext();)
		{
