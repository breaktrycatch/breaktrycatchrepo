...
public class TiledFrameExporter
{
		...
		if (isTiling)
		{
			...
			if (subTileID > 1)
			{
				...
				if (tileID == offsets.length - 1)
					buffer.save(parent.sketchPath(fileName + "_" + buffer.width + "x" + buffer.height + ".png"));
				subTileID = 0;
	...
	{
		Vec3D o = offsets[id];
		parent.frustum(o.x, o.x + (float) normTileSize, (float) (o.y * aspect), (float) (aspect * (o.y + normTileSize)), 0.01f, 10000.f);
	}
