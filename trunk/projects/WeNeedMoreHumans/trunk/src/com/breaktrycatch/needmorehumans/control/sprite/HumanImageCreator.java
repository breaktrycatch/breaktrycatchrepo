...
public class HumanImageCreator
{
	...
	{ "../data/tracing/RealPerson_1.png", "../data/tracing/RealPerson_3.png", "../data/tracing/RealPerson_4.png", "../data/tracing/RealPerson_5.png", "../data/tracing/RealPerson_6.png",
			"../data/tracing/RealPerson_7.png", "../data/tracing/RealPerson_8.png", "../data/tracing/RealPerson_10.png", "../data/tracing/RealPerson_11.png",
			// "../data/tracing/RealPerson_13.png",
			"../data/tracing/RealPerson_14.png", "../data/tracing/RealPerson_15.png", "../data/tracing/RealPerson_16.png" };

	private Rectangle[] _rectangleLookup = new Rectangle[]
	{ new Rectangle(15, 60, 50, 50), new Rectangle(120, 30, 30, 30), new Rectangle(60, 25, 47, 47), new Rectangle(72, 28, 44, 44), new Rectangle(21, 1, 42, 42), new Rectangle(28, 19, 36, 36),
			new Rectangle(41, 15, 36, 36), new Rectangle(30, 12, 34, 34), new Rectangle(32, 4, 48, 48),
			// new Rectangle(12, 4, 31, 31)
			new Rectangle(93, 4, 54, 54), new Rectangle(23, 1, 54, 54), new Rectangle(48, 23, 44, 44), };
