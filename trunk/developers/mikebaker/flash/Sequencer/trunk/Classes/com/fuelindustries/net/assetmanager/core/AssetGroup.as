package com.fuelindustries.net.assetmanager.core {
	...
	import com.fuelindustries.net.assetmanager.core.assets.BitmapAsset;
	import com.fuelindustries.net.assetmanager.core.assets.SWFAsset;
	import com.fuelindustries.net.assetmanager.core.assets.XMLAsset;
	...
	public class AssetGroup extends EventDispatcher {
		...
		public function addAsset(_path:String, _assetName:String = ""):void {
			//The asset name is the filename with no extention
			var assetName:String = (_assetName == "") ? _path : _assetName;
			if (__assets[assetName] != null) {
				throw new Error("Group Asset " + assetName + " already exists!");
			}
