package com.fuelindustries.media.sound 
{
	...
	public class SoundManager extends EventDispatcher
	{
		...
		{
			var sound:NetStreamSound = new NetStreamSound( stream );
			stream.soundTransform = new SoundTransform( isMuted ? 0 : 1 );
			registerSound( id, sound );
		}

		public function addMP3Stream( id:String ):void
		{
			var sound:MP3Sound = new MP3Sound( id );
			registerSound( id, sound );
		}
		...
		public function playSound( id:String, startTime:Number = 0, loops:int = 0, sndTransform:SoundTransform = null ):SoundChannel
		{
			...
			{
				throw new IllegalOperationError( id + " is not a sound that can be played from the SoundManager class" );	
			}
			return null;
		}
		...
		public function stopSound( id:String ):void
		{
			...
			{
				throw new IllegalOperationError( id + " is not a sound that can be stopped from the SoundManager class" );	
			}
		}
