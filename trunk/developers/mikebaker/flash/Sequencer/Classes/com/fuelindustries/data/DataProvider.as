package com.fuelindustries.data
{
     ...
     * 
	 */
	[Event(name="dataChange", type="com.fuelindustries.events.DataProviderEvent")]
	...
	public class DataProvider extends EventDispatcher
	{
		...
		{
			init( dp, dispatchCreate );
		}
		
		private function init( dp:Array = null, dispatchCreate:Boolean = false ):void
		{
			if( dp == null )
			{
				items = [];
		...
		{
			var event:DataProviderEvent = new DataProviderEvent( type, startIndex, endIndex );
			dispatchEvent( event );
		}
