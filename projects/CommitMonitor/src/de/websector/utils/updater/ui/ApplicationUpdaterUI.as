package de.websector.utils.updater.ui
{
		...
		{	
			 ...
			 * 
			 */	
			public function ApplicationUpdaterUI( 	updateURL: String = null,
												...
												)
			{
				...
				this.configurationXMLURL = updateURL;
			...
			protected function initUpdater():void
			{
				...
				appUpdater.updateURL = configurationXMLURL;
			...
			protected function show():void
			{
				...
				else
				{
					...
					trace("SHOW!!!");
					var showEffect : Fade = new Fade(this);
					showEffect.duration = 500;
					showEffect.alphaTo = 1;
					showEffect.alphaFrom = 0;
					
					var scaleEffect : Scale = new Scale(this);
					scaleEffect.duration = 500;
					scaleEffect.scaleYFrom = 0;
					scaleEffect.scaleYTo = 1;
			...
			protected function hide( cancelUpdate: Boolean = true ):void
			{
				...
				var hideEffect : Fade = new Fade(this);
				hideEffect.duration = 500;
				hideEffect.alphaTo = 0;
				hideEffect.alphaFrom = 1;
				hideEffect.addEventListener(EffectEvent.EFFECT_END, function(e:EffectEvent):void
				{
					hideEffect.removeEventListener(EffectEvent.EFFECT_END, arguments.callee);
					if ( useWindow )
						destroyWindow();
					else
			...
			public function get configurationXMLURL():String
			{
				return _configXMLURL;
			}
			
			/**
			 * 
			 */				
			public function set configurationXMLURL(value:String):void
			{
				if ( value == null )
					return;
