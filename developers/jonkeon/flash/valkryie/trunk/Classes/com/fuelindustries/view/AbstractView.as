package com.fuelindustries.view
{
	 ...
	 * 
     * @eventType com.fuelindustries_assetproxy.events.ViewEvent.CHANGE
     * 
	 */
	[Event(name="changeSection", type="com.fuelindustries_assetproxy.events.ViewEvent")]
	
	/**
	 * Dispatched when the view has completed it's out transition and is ready to be removed by the View manager
	 * 
     * @eventType com.fuelindustries_assetproxy.events.ViewEvent.OUT_COMPLETE
     * 
	 */
	[Event(name="outComplete", type="com.fuelindustries_assetproxy.events.ViewEvent")]
