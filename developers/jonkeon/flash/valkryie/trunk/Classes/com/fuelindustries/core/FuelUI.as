package com.fuelindustries.core {
	 ...
	 */
	public class FuelUI extends AssetProxy
	{
		/** @private */
		 ...
		 * @param func The name of the function to execute. Do not include quotation marks or parentheses, and do not specify parameters of the function to call. For example, use functionName, not functionName() or functionName(param). 
		...
		/**
		 * A wrapper function for Log.debug so the classes doesn't need to be imported in every class. This works just like the trace function where you can specify an array to be used and it will concat the message into 1 string for you.
