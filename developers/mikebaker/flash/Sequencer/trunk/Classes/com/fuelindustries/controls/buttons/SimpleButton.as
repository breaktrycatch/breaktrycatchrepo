package com.fuelindustries.controls.buttons
{
	 ...
	 * 
	 *  @eventType ccom.fuelindustries.events.FuelMouseEvent.PRESS
	 *  
	 * */
	[Event(name="press", type="com.fuelindustries.events.FuelMouseEvent")]
	...
	public class SimpleButton extends FuelUI
	{
		...
		protected function checkForLabel( label : String ) : Boolean
		{
			...
			{
				var frame:FrameLabel = labels[ i ] as FrameLabel;
